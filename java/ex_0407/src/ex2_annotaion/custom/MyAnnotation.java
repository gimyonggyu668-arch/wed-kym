...
import java.lang.annotation.*;           // Retention, Target 등 모든 도구
import static java.lang.annotation.ElementType.*;     // TYPE, FIELD 등
import static java.lang.annotation.RetentionPolicy.*; // RUNTIME, SOURCE 등
